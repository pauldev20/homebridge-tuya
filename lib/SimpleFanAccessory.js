...
class SimpleFanAccessory extends BaseAccessory {
    ...
    _registerCharacteristics(dps) {
        ...
        this.speedLevelsTag = this.device.context.speedLevelsTag || false;
        this.speedLevels = this.device.context.speedLevels || 3;
...
/* ---------------------------------- Speed --------------------------------- */
    getSpeed(callback) {
        this.getState(this.dpRotationSpeed, (err, dp) => {
            ...
            // console.log("_getSpeed = " + this._getSpeed(dp));
    ...
    _getSpeed(dp) {
        ...
        if (this.speedLevelsTag) {
            return dp.replace('level_', '');
        }
        return dp;
    }
    ...
    setSpeed(value, callback) {
        ...
        if (value == 0) {
            ...
            if (this.speedLevelsTag) {
                // console.log("setSpeed = " + 'level_' + value.toString());
                return this.setState(this.dpRotationSpeed, 'level_' + value.toString(), callback);
            }
